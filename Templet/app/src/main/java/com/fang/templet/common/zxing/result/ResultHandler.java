...
package com.fang.templet.common.zxing.result;

import com.fang.templet.util.StringUtils;
import com.google.zxing.Result;
import com.fang.templet.common.zxing.Contents;
import com.fang.templet.common.zxing.Intents;
import com.fang.templet.common.zxing.LocaleManager;
import com.fang.templet.common.zxing.PreferencesActivity;
import com.fang.templet.R;
import com.fang.templet.common.zxing.book.SearchBookContentsActivity;
  ...
  final void addContact(String[] names,
    ...
    if (nicknames != null) {
      for (String nickname : nicknames) {
        if (nickname != null && !StringUtils.isNullOrEmpty(nickname)) {
          ContentValues row = new ContentValues(3);
