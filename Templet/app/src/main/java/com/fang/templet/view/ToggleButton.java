...
import com.fang.templet.view.rebound.SimpleSpringListener;
import com.fang.templet.view.rebound.Spring;
import com.fang.templet.view.rebound.SpringConfig;
import com.fang.templet.view.rebound.SpringSystem;
import com.fang.templet.view.rebound.SpringUtil;
...
public class ToggleButton extends View {
    ...
    public void setup(AttributeSet attrs) {
        ...
        offBorderColor = typedArray.getColor(R.styleable.MyToggleButton_myoffBorderColor, offBorderColor);
        onColor = typedArray.getColor(R.styleable.MyToggleButton_myonColor, onColor);
        spotColor = typedArray.getColor(R.styleable.MyToggleButton_myspotColor, spotColor);
        offColor = typedArray.getColor(R.styleable.MyToggleButton_myoffColor, offColor);
        borderWidth = typedArray.getDimensionPixelSize(R.styleable.MyToggleButton_myborderWidth, borderWidth);
        defaultAnimate = typedArray.getBoolean(R.styleable.MyToggleButton_myanimate, defaultAnimate);
        typedArray.recycle();
